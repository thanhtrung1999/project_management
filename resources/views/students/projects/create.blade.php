        ...
        <div class="col-md-12">
            ...
            <div class="card card-primary">
                <div class="card-header">
                    <h3 style="font-size: 1.5rem" class="card-title">Tạo đồ án</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form action="{{ route('student.project.create') }}" enctype="multipart/form-data" method="POST">
                    @csrf
                    <div class="card-body row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="subject" class="form-control" name="subject" id="subject"
                                    value="{{ old('subject') }}" placeholder="Nhập tên môn học">
                            </div>
                            <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="documents">File đồ án</label>
                                <div>
